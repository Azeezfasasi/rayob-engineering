...
export default function DashboardMenu({ collapsed, mobileOpen = false, onClose = () => { } }) {
  ...
  const desktopNav = (
    <nav className={`hidden md:flex h-screen bg-blue-900 border-r border-gray-100 md:overflow-y-auto ${collapsed ? 'w-16' : 'w-75'} transition-width duration-200`} aria-label="Dashboard navigation">
        ...
        <div className="h-full overflow-y-auto py-6 px-4">
          <div className="flex items-center justify-between mb-6">
            <Link href="/" className="flex flex-col items-center gap-3">
              <Image src="/images/rayoblogonew.jpeg" alt="Rayob Logo" width={170} height={50} className="w-16 block rounded-md" />
            </Link>
